...
def parity_analysis(num):
    # Estoy diciendole que recorra un string que viene del numero, y que luego lo almacene como número
    #uso suma para sumar todos los numeros del iterable.
    reduction = sum([int(n) for n in str(num)])
    if num%2 != 0 and reduction%2 !=0:
        return True
    elif num%2 == 0 and reduction%2 ==0:
        return True
    else:
        return False

for n in range(1000):
    print(parity_analysis(n))
