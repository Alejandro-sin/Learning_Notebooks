...
// Porceso los datos que recibo para el ejemplo:
// Tengo usuarios y el numeor total de interacciones.
...
const maxInteractions = d3.max(dataSet,function(d){
...
const highInteractions =  hostInteractions.filter(function(d){
...
//Aqui voy a requerir que mis datos vengan de la siguiente manera:
//Usuario,TABLA
//id row, interaccionesWS, interaccionesGM data[0]